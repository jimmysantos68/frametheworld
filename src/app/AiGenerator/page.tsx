...
<Header />
      <div className="w-[80%]  mx-auto min-h-screen  p-6">
        {/* Back Button */}
        <button className="flex items-center gap-2 text-gray-700 mb-8 hover:text-gray-900 transition-colors">
          <ArrowLeft size={20} />
        </button>
          ...
          <div className="space-y-6">
            ...
            <div className="mb-8">
              <div className="flex justify-center gap-3 mb-4">
                <div className="">
          <Image src="/images/stars.png" alt="Stars" width={110} height={110} className=''/>
                </div>
              </div>
...
{}
      ...
      <label htmlFor="fileInput" className="cursor-pointer"> <div className="space-y-4"> <h3 className="text-blue-600 font-medium text-lg">Upload Pictures</h3> <p className="text-gray-500 text-sm">Max Limit 5Mbs, PNG, JPG, JPEG</p> </div> </label>
      </div>
      ) :  <label
        htmlFor="fileInput"
...
>
  ...
  {!generated ? (
    ...
    <div className="text-center">
      ...
      <p className="text-[#6CACDF80] font-medium">
    ...
    // 🔹 Generated Content
    <div className="relative rounded-3xl p-8 min-h-[500px] w-full
      bg-gradient-to-b from-[#EEF4FF] to-[#E3ECFF]">
      ...
      <div className="absolute bottom-6 right-6 flex items-center gap-4">
        <button
          className="w-10 h-10 rounded-xl bg-gradient-to-b from-[#6CACDF] to-[#0000FE]
